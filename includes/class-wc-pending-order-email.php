<?php
/**
 * Class WC_Email_Pending_Order file
 *
...
if ( ! class_exists( 'WC_Email_Pending_Order' ) ) :

	/**
	 * Pending Order Email.
	 *
	 * An email sent to the admin when a pending order is received/paid for.
	 *
	 * @class       WC_Email_Pending_Order
	 * @version     2.0.0
	...
	class WC_Email_Pending_Order extends WC_Email {
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Pending order #{order_number}', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Pending Order: #{order_number}', 'woocommerce' );
		}
...
return new WC_Email_Pending_Order();